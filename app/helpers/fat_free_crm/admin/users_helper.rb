...
module FatFreeCrm
  module Admin::UsersHelper
    ...
    def user_summary(user)
      ...
      summary << user.email
      summary << "#{t :phone_small}: #{formatted_phone_number(user.phone)}" unless user.phone.blank?
      summary << "#{t :mobile_small}: #{formatted_phone_number(user.mobile)}" unless user.mobile.blank?
