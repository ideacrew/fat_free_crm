...
module FatFreeCrm
  class IndexCasesController < EntitiesController
          ...
          if params['absence_begin_date'].present?
            absence = Absences::FindOrCreate.new.call(contact: @index_case.contact, 
                                                absence_params: {
                                                  ...
                                                  start_on: Date.parse(params['absence_begin_date']),
                                                  end_on: Date.parse(params['absence_begin_date']) + 14.days
                                                })
          end
          get_data_for_sidebar
        end
    ...
    def index_case_params
      params.require(:index_case).permit(:projected_return_date, :absence_begin_date,
