...
Gem::Specification.new do |gem|
  ...
  gem.add_development_dependency 'bootsnap' #, require: false
  gem.add_development_dependency 'tzinfo-data' #, platforms: %i[mingw mswin x64_mingw jruby]
  ...
  gem.add_development_dependency 'email_reply_parser_ffcrm'
