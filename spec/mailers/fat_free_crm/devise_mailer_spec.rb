  ...
  describe DeviseMailer do
    describe "reset_password_instructions" do
      ...
      it "includes password reset link in body" do
        expect(mail.body.encoded).to have_link('Change my password', href: "http://localhost:3000/crm/users/password/edit?reset_password_token=#{user.reset_password_token}")
      end
    end
  end
end
