    ...
    describe "assigned_entity_notification" do
      ...
      context "for an account" do
        ...
        it "includes link to the lead in the body" do
          expect(mail.body.encoded).to match("http://localhost:3000/crm/accounts/16")
        end
      end
      ...
      context "for a contact" do
        ...
        it "includes link to the lead in the body" do
          expect(mail.body.encoded).to match("http://localhost:3000/crm/contacts/56")
        end
      end
      ...
      context "for a lead" do
        ...
        it "includes link to the lead in the body" do
          expect(mail.body.encoded).to match("http://localhost:3000/crm/leads/42")
        end
      end
      ...
      context "for an opportunity" do
        ...
        it "includes link to the lead in the body" do
          expect(mail.body.encoded).to match("http://localhost:3000/crm/opportunities/24")
        end
      end
    end
  end
